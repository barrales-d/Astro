...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, group):
        ...
        self.animator = Animator('./graphics/ship_spritesheet_outline.png', 32, 3, 3, pos)
        ...
        self.unrotated_image = pygame.transform.scale_by(self.animator.get_frame().image, SPRITE_SCALER)
